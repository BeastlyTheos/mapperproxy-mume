...
class Mapper(threading.Thread, World):
	...
	def emulation_command_rname(self, *args):
		"""changes the room name"""
		self.emulationRoom.name = args[0]
		self.output("Room name set to " + args[0])
	...
	def user_command_emu(self, *args):
		...
		# try to expand the user command to the full name of an emulation command
